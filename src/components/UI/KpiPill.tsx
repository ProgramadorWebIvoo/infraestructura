...
interface KpiPillProps {
  ...
  /** Explicación breve del KPI (ej. qué cuenta, qué estados incluye) —
   * se muestra en un Tooltip al hacer hover/focus sobre el pill. */
  tooltip?: ReactNode;
}
...
export default function KpiPill({ icon, label, value, accent = "brand", tooltip }: KpiPillProps) {
