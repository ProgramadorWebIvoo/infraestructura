...
import { AlertTriangle, BrainCircuit, Clock, Gauge, SearchX, ShieldCheck, Star, Trophy, Users, Wallet, XCircle } from "lucide-react";
...
import { containerVariants, itemVariants, springs, viewSwitchVariants } from "../../../animations";
 ...
 * más pesa en la decisión de Procura, así que ocupa el doble de espacio con
 * número más grande y una barra visual comparando el costo contra el
 * presupuesto autorizado (antes las 4 métricas eran cajas idénticas sin
 * jerarquía, obligando al lector a leer las 4 para encontrar la relevante).
 */
